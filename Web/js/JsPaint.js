...
var elt = function (name, attributes) {
...
var createPaint = function (parent) {
...
var loadImageURL =function (cx, url)  {
...
var randomPointInRadius = function (radius) {
  for (;;) {
...
var forEachNeighbor = function (point, fn) {
...
var isSameColor = function (data, point1, point2) {
  ...
  return true;
    ...
    randomPointInRadius: randomPointInRadius,
    /************************************************************************
     * controls
     ***********************************************************************/
